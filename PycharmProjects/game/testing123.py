### max health of 100 - Done
### computer to attack or rest back
### call the class function with the four moves -DONE
### input(select moves 1, 2, 3 or 4) 1 rest, 2 attack 1, 3 ... - DONE
### 1 = squirtle.watergun() -DONE
